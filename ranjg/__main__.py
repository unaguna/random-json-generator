...
parser.add_argument("--jsonoutput", "-j", required=True, help="Path to which json file is written.")

args = parser.parse_args()

gen(schema_file=args.schema_file_path, output_file=args.jsonoutput)
